...
(['js/controls.jsx!github:floatdrop/plugin-jsx@1.2.1'], function(System) {
...
System.register('js/controls.jsx!github:floatdrop/plugin-jsx@1.2.1', ['js/socket'], function (_export) {
  'use strict';
    ...
    execute: function () {
      Controls = React.createClass({ displayName: "Controls",
        ...
        render: function render() {
          return React.createElement("div", null, React.createElement("button", { onClick: this.start }, "start"), React.createElement("button", { onClick: this.stop }, "stop"), React.createElement("button", { onClick: this.reset }, "reset"));
        }
      });
